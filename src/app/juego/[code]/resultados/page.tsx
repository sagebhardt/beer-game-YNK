  ...
  return (
    ...
    >
      ...
      <div className="mb-4 grid grid-cols-1 gap-3 md:grid-cols-4">
        ...
        <Card>
          <CardContent className="py-4">
            <p className="text-xs uppercase tracking-wide text-[var(--text-muted)]">Mejor partida (récord)</p>
            ...
            {optimal && optimal.totalChainCost > 0 && Number.isFinite(totalChainCost / optimal.totalChainCost) && (
              <p className="mt-0.5 text-xs text-[var(--text-muted)]">
                {((totalChainCost / optimal.totalChainCost - 1) * 100).toFixed(0)}% sobre récord
              </p>
            )}
          </CardContent>
        </Card>
